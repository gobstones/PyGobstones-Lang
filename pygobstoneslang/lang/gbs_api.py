...
import gbs_io
import json
from board.fmt_json import JsonBoardFormat
...
class GobstonesOptions(object):
    ...
    def __init__(self, lang_version=LangVersion.Gobstones,
            lint_mode="lax", check_liveness=False, check_types=False,
            jit=False, allow_recursion=False, test_suite=False):
...
class GobstonesRun(object):
    ...
    def initialize(self, tree=None, compiled_program=None,
            initial_board=None, final_board=None, runnable=None,
            result=[],
            assertions=[]):
